                  ...
                  <div className="lg:col-span-2 mt-7">
                    <div className="grid gap-4 gap-y-2 text-md grid-cols-1 md:grid-cols-5 space-y-2">
                      ...
                      <div className="md:col-span-2 text-zinc-600">
                        ...
                        {/* <svg class="w-2 h-2 absolute top-0 right-0 m-4 pointer-events-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 412 232"><path d="M206 171.144L42.678 7.822c-9.763-9.763-25.592-9.763-35.355 0-9.763 9.764-9.763 25.592 0 35.355l181 181c4.88 4.882 11.279 7.323 17.677 7.323s12.796-2.441 17.678-7.322l181-181c9.763-9.764 9.763-25.592 0-35.355-9.763-9.763-25.592-9.763-35.355 0L206 171.144z" fill="#648299" fill-rule="nonzero" /></svg> */}
                        <select
                          className="h-9 px-2 text-stone-600 font-medium border border-slate-300 rounded w-full bg-stone-200 focus:outline-none appearance-none"
                    ...
                    <div className="grid gap-4 gap-y-2 text-md grid-cols-1 md:grid-cols-5 space-y-2">
                      ...
                      <div className="md:col-span-3 space-x-5 flex flex-col justify-end text-zinc-600">
                        ...
                        <label className="text-right">
                          GST<span className="font-medium"> @18%</span>
                        </label>
                        <br />
                      ...
                      <div className="md:col-span-1 space-x-5 flex flex-col justify-end text-stone-600 font-medium">
                        <label className="text-end">{shipping}</label>
                        <br />
                      ...
                      <div className="md:col-span-5">
                        <button
                          type="submit"
                          className="w-full flex justify-center rounded-full bg-indigo-500 hover:bg-indigo-700 hover:text-white p-3 text-stone-300 font-semibold text-xl tracking-wide shadow-lg transistion ease-in-out duration-300"
                        >
                          Pay Now
                        </button>
                      </div>
